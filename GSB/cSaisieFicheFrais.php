 ...
 */
  ...
  elseif ($etape == "validerAjoutLigneHF") {
      ...
      if ( nbErreurs($tabErreurs) == 0 ) {
          ...
          ajouterLigneHF($idConnexion, obtenirIdUserConnecte(), $dateHF, $libelleHF, $montantHF);
      }
  }
...
?>
  <!-- Division principale -->
  <div id="contenu">
      <h3>Renseigner ma fiche de frais du mois de <?php echo obtenirLibelleMois(intval(substr($mois,4,2))) . " " . substr($mois,0,4); ?></h3>
<?php
...
<?
	...
	$req="SELECT count(*) AS nb FROM LigneFraisHorsForfait INNER JOIN LigneFraisForfait
	...
	{
	?>
		<div class="corpsForm"><p style="text-align:center;">Pas de fiche de frais hors forfait pour ce visiteur ce mois.</p></div></br ></div>
	<?	
	}
	else
	{
      ...
      <div class="corpsForm">
          <input type="hidden" name="etape" value="validerAjoutLigneHF" />
            ...
            <p>
              ...
              <input type="text" id="txtLibelleHF" name="txtLibelleHF" size="30" maxlength="100" 
